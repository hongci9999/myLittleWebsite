...
{"title":"","summary":"","bodyMd":"","sourceKind":"x","tags":[]}`
  ...
  /** Gemini YouTube URL 입력용 — 자막 텍스트 없이 영상·음성을 직접 분석 */
  deepAnalysisNoteYoutube(url: string): string {
    return `역할: 웹 스크랩용 **심층 분석 노트** 작성. 첨부된 YouTube 공개 영상을 시청·청취한 뒤 한국어로만 답하세요.
...
6) **전제·한계**: 영상에서 밝힌 제한, 주의, 불확실한 부분

불확실하면 [추측]이라고 표시하세요. 영상을 재생할 수 없거나 내용이 비어 있으면 그 사실을 명시하세요.
